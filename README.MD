...
[Staging Site](https://isomo-test-site.netlify.app/)
...
- [] setup .env with MONGO_URL_DEV and MONGO_URL_PROD variables and assign the values
...
#### Authorize Permissions Complete (not yet implemented)

- [] introduce params

#### ShowCurrentUser (not yet implemented)

- [] get user from req
- [] send response with user

#### UpdateUserPassword (not yet implemented)
...
#### Product Model (not yet implemented)
...
#### Product Structure (not yet implemented)
...
#### Create Product (not yet implemented)
...
#### Upload Image (not yet implemented)
...
#### Review Structure (not yet implemented)
...
#### Create Review (not yet implemented)
...
#### Get All Reviews and Get Single Review (not yet implemented)

- [] both public routes, typical setup

#### Delete Review (not yet implemented)
...
#### Update Review (not yet implemented)
...
#### Order Schema (not yet implemented)
...
#### Order Structure (not yet implemented)
...
#### Get All Orders and Get Single Order (not yet implemented)

- [] getAllOrders - admin only
- [] getSingleOrder - checkPermissions

#### Get Current User Orders (not yet implemented)
